    ...
    return (
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl lg:text-7xl font-medium mt-6 text-center max-w-2xl mx-auto">Questions ? We&apos;ve got <span className="text-lime-400">answers</span></h2>
                            ...
                            <div key={faq.question} className="bg-neutral-900 rounded-2xl border border-white/10 p-6">
                               <div className="flex justify-between items-center"  onClick={()=>setSelectedIndex(faqIndex)}>
                                <h3 className="font-medium  ">{faq.question}</h3>
                                 <Plus className={twMerge("text-lime-400 flex-shrink-0 transition duration-300", selectedIndex === faqIndex && 'rotate-45')}/>
                               </div>
